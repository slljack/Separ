...
package it.unibs.gs.interfaces;


public interface GSRevocationList
{
	public void addRevokedMember(GSIdentity member);
	public GSIdentity [] getRevokedMembers();
	public GSIdentity [] getRevokedMembers(int timestamp);
}
