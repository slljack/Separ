...
import it.unibs.gs.cg.CGMemberKeyImpl;
...
public class CGMemberCertificate extends GSMemberCertificate {
    /**
     * 
     */
    private static final long serialVersionUID = -3913275653553161884L;

    public CGMemberCertificate(String algorithm, float version, String issuer, String subject, Date startDate,
    ...
    @Override
    public CGMemberKeyImpl getMemberKey() {
        return (CGMemberKeyImpl) key;
    }
